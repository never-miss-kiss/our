...
//   按用户号查询
//   按发布时间，热度,点击量排序
// userId 用户号，schoolId 学校号，sortId（排序方式：1.按发布时间，2.热度,3.点击量排序）
...
//            删除跑腿信息评论
    public boolean removeHelpComment(HelpComment helpComment);

//    /help/removeHelpCommentReply.action
//            删除跑腿信息评论回复
    public boolean removeHelpCommentReply(HelpCommentReply helpCommentReply);
