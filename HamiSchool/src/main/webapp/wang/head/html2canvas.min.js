...
(function (t, e, n) {
    ...
    u.Util = {}, u.Util.log = function (e) {
        ...
        return function (e, r, a) {
            ...
            var o, i, l, s = a.createElement("div"), c = a.createElement("img"), d = a.createElement("span"),
                u = "Hidden Text";
        ...
        r.parseGradient = function (t, e) {
            ...
            var e, n = ["M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"],
                r = [1e3, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1], a = "", o = n.length;
        ...
        function m(t, e, r, a) {
            var o = !1, i = ge(e, "fontWeight"), l = ge(e, "fontFamily"), s = ge(e, "fontSize"),
        ...
        function v(t, e, n) {
            var r, o, i = n.ctx, l = ge(t, "color"), s = ge(t, "textDecoration"), c = ge(t, "textAlign"),
        ...
        function R(t, e) {
            var n = Math.max(t.left, e.left), r = Math.max(t.top, e.top),
                a = Math.min(t.left + t.width, e.left + e.width), o = Math.min(t.top + t.height, e.top + e.height);
            return {left: n, top: r, width: a - n, height: o - r}
        }

        function E(t, e, n) {
            var r, a = "static" !== e.cssPosition, o = a ? ge(t, "zIndex") : "auto", i = ge(t, "opacity"),
        ...
        function U(t, e, n) {
            var r = t.left, a = t.top, o = t.width, i = t.height, l = e[0][0], s = e[0][1], c = e[1][0], d = e[1][1],
                u = e[2][0], h = e[2][1], f = e[3][0], p = e[3][1], g = o - c, m = i - h, y = o - u, b = i - p;
            return {
        ...
        function P(t, e, n) {
            var r, a, o, i, l, s, c = e.left, d = e.top, u = e.width, h = e.height, f = O(t), p = U(e, f, n),
        ...
        function _(t, e, n, r, a) {
            var o = ue.BackgroundSize(t, e, r, a), i = ue.BackgroundPosition(t, e, r, a, o),
        ...
        function re(t, e, n, r) {
            var a, o = Z(t, e), i = ne(t, o), l = te(t, e, i, o), s = l.borders, c = l.ctx, d = ee(s, i, l.clip),
                u = P(t, i, s), h = fe.test(t.nodeName) ? "#efefef" : ge(t, "backgroundColor");
        ...
        function le() {
            var t = ge(e.documentElement, "backgroundColor"), n = ue.isTransparent(t) && se === e.body,
                r = re(se, null, !1, n);
            return ie(se, r), n && (t = r.backgroundColor), pe.removeChild(ye), {backgroundColor: t, stack: r}
        }

        t.scroll(0, 0);
        var se = a.elements === n ? e.body : a.elements[0], ce = 0, de = se.ownerDocument, ue = u.Util,
            he = ue.Support(a, de), fe = RegExp("(" + a.ignoreElements + ")"), pe = de.body, ge = ue.getCSS,
            me = "___html2canvas___pseudoelement", ye = de.createElement("style");
        ...
        var g, m, y, b, w = {numLoaded: 0, numFailed: 0, numTotal: 0, cleanupDone: !1}, x = u.Util, v = 0,
            k = r.elements[0] || e.body, C = k.ownerDocument, T = k.getElementsByTagName("img"), S = T.length,
            M = C.createElement("a"), R = function (t) {
        ...
        function a(t) {
            ...
            return r = function (t) {
                function e(t, r, a) {
                    var o = "auto" === r.zIndex.zindex ? 0 : Number(r.zIndex.zindex), i = t, l = r.zIndex.isPositioned,
                        s = r.zIndex.isFloated, c = {node: r}, d = a;
        ...
        t = t || {};
        var i = e, l = [], s = e.createElement("canvas"), c = s.getContext("2d"), d = u.Util,
