    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <c:if test="${param.info == '1' }">
  			<span style='color:red;font-size:9pt'>密码错误！</span>
			</c:if>
			
			<c:if test="${param.info == '2' }">
				<span style='color:red;font-size:9pt'>用户不存在！</span>
			</c:if>      
            <form action="${pageContext.request.contextPath }/admin/admin_adminLogin" method="post">
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>IN后台管理中心</h1></div>
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input input-big" name="admin.adminName" placeholder="登录账号"  data-validate="required:请填写账号" />
