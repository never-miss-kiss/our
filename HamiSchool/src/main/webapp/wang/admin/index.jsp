...
<div class="header bg-main">
  ...
  <div class="head-l">
	  <a class="button button-little bg-green" href="${pageContext.request.contextPath }/tian/index/index.jsp" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul >
    ...
    <li><a href="${pageContext.request.contextPath }/wang/blank.jsp" target="right"><span class="icon-caret-right"></span>管理推送信息</a></li>

    <li><a href="${pageContext.request.contextPath }/wang/admin/addAdmin.jsp" target="right"><span class="icon-caret-right"></span>管理员管理</a></li>
    ...
    <li><a href="${pageContext.request.contextPath }/wang/blank.jsp" target="right"><span class="icon-caret-right"></span>首页轮播</a></li>
    <li><a href="${pageContext.request.contextPath }/wang/blank.jsp" target="right"><span class="icon-caret-right"></span>反馈信息</a></li>
  </ul>   
  ...
  <ul>
    ...
    <li><a href="${pageContext.request.contextPath }/wang/blank.jsp" target="right"><span class="icon-caret-right"></span>跑腿管理</a></li>
