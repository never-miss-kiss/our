...
<div class="container-fluid">
    ...
    <div class="col-sm-8  middle">
        <form class="form-horizontal" action="<%=basePath%>/help/addHelpFetch.action">
            <div class="form1">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="fetchAddress" class="form-control" id="suggestId" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">备注地址</label>
                    <div class="col-sm-7">
                        <input type="text"  name="remarkShipAddress" class="form-control" id="inputEmail3" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">取货电话</label>
                    <div class="col-sm-7">
                        <input type="text"  name="fetchPhone"  class="form-control" id="inputEmail3" placeholder="">
                    </div>
                </div>
            </div>
            <div class="form2">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">备注地址</label>
                    <div class="col-sm-7">
                        <input type="text"  name="remarkReciptAddress"  class="form-control" id="inputEmail3" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text"  name="fetchInfomation"  class="form-control" id="inputEmail3" placeholder="请填写物品具体信息">
                    </div>
                </div>
    ...
    <div class="col-sm-2  right">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation" class="active"><a href="<%=basePath%>tian/addHelpFetch/addHelpFetch.jsp"><h3>帮我取</h3></a></li>
