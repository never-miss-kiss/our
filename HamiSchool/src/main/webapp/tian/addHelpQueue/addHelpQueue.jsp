...
<div class="container-fluid">
    ...
    <div class="col-sm-8  middle">
        <form class="form-horizontal" action="<%=basePath%>/help/addHelpQueue.action">
            <div class="form1">
                    ...
                    <div class="col-sm-7">
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-primary active">
                                <input type="radio" name="name" id="option1" autocomplete="off" checked> 各种排队
                            </label>
                            <label class="btn btn-primary">
                                <input type="radio" name="name" id="option2" autocomplete="off"> 办事排队
                            </label>
                            <label class="btn btn-primary">
                                <input type="radio" name="name" id="option3" autocomplete="off"> 医院排队
                            </label>
                            <label class="btn btn-primary">
                                <input type="radio" name="name" id="option3" autocomplete="off"> 银行排队
                            </label>
                            <label class="btn btn-primary">
                                <input type="radio" name="name" id="option3" autocomplete="off"> 餐厅占座
                            </label>
                            <label class="btn btn-primary">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text"  name="remarkInformation" class="form-control" id="inputEmail3" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="queueAddress" class="form-control" id="suggestId" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">备注地址</label>
                    <div class="col-sm-7">
                        <input type="text"  name="remarkQueueAddress" class="form-control" id="inputEmail3" placeholder="">
                    </div>
                </div>
            ...
            <div class="form2">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text"  name="queuePhone"  class="form-control" id="inputEmail3" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group" >
                    ...
                    <div class="col-sm-2">
                        <select class="form-control col-sm-2" name="queueDay">
                            <option>0天</option>
                            <option>1天</option>
                            <option>2天</option>
                            <option>3天</option>
                    ...
                    <div class="col-sm-2">
                        <select class="form-control col-sm-2" name="queueHour">
                            <option>0小时</option>
                            <option>1小时</option>
                            <option>2小时</option>
                            <option>3小时</option>
                    ...
                    <div class="col-sm-2">
                        <select class="form-control col-sm-2" name="queueMinute">
                            <option>30分钟</option>
                            <option>0分钟</option>
                        </select>
                    </div>
    ...
    <div class="col-sm-2  right">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation" class="active"><a href="<%=basePath%>tian/addHelpQueue/addHelpQueue.jsp"><h3>代排队</h3></a></li>
        </ul>
    </div>
