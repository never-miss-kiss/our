            ...
            if (j > 1) {
                if (v) {
                    $(document).keydown(function (e) {
                        ...
                        B(h);
                        $(o).animate({left: $(p).eq(h).find('span').offset().left - $(n).offset().left}, 200, function () {
                            k = true;
                ...
                if (u == 'click') {
                    ...
                    $(o).draggable({axis: 'x', containment: 'parent', revert: 'invalid'});
                    $(p).droppable({
                        accept: o, over: function (a, b) {
                            ...
                            $(o).animate({left: $(this).find('span').offset().left - $(n).offset().left}, 200, function () {
                                $(this).attr('title', $(p).eq(h).find('span').attr('title'))
                            });
                            var c = $(this).find('span').css('background-color');
                            $('body').css('background-color', c);
