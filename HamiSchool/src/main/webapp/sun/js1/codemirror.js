...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        wrapper.innerHTML =
            '<div style="overflow: hidden; position: relative; width: 2px; height: 14px;">' + // Wraps and hides input textarea
                '<textarea style="position: absolute; padding: 0; width: 2px;border: none;" wrap="off" ' +
                'autocorrect="off" autocapitalize="off"></textarea></div>' +
                '<div class="CodeMirror-scroll" tabindex="-1">' +
                '<div style="position: relative">' + // Set to the height of the text, causes scrolling
                '<div style="position: relative">' + // Moved around its parent to cover visible view
                '<div class="CodeMirror-gutter" id="CodeMirror-gutter"><div class="CodeMirror-gutter-text"></div></div>' +
