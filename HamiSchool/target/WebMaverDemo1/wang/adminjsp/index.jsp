...
<div class="leftnav">
  ...
  <ul >
    <li><a href="${pageContext.request.contextPath }/wang/adminjsp/pushMessage/push.jsp" target="right"><span class="icon-caret-right"></span>推送消息</a></li>
    <li><a href="${pageContext.request.contextPath }/admin/admin_pushList" target="right"><span class="icon-caret-right"></span>管理推送信息</a></li> 
    <li><a href="${pageContext.request.contextPath }/jsp/updateAdmin.jsp" target="right"><span class="icon-caret-right"></span>修改个人信息</a></li>
    <li><a href="${pageContext.request.contextPath }/jsp/updateAdmin.jsp" target="right"><span class="icon-caret-right"></span>增加管理员</a></li>
    <li><a href="${pageContext.request.contextPath }/jsp/updateAdmin.jsp" target="right"><span class="icon-caret-right"></span>修改管理员权限</a></li>
    <li><a href="${pageContext.request.contextPath }/jsp/updateAdmin.jsp" target="right"><span class="icon-caret-right"></span>查找管理员</a></li>
